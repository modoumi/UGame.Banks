...
namespace Xxyy.Banks.Orionpay
{
    ...
    public sealed class RSAUtils
    {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns>明文</returns>
        public static string encrypt(string resData, string publicKey, string input_charset = "utf-8")
        {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns>明文</returns>
        public static string decrypt(string resData, string privateKey, string input_charset="utf-8")
        {
