...
namespace Lobby.Flow.DAL
{
	...
	public class Sc_cash_auditMO : MySqlTableMO<Sc_cash_auditEO>
	{
	    ...
	    private void RepairAddData(Sc_cash_auditEO item, bool useIgnore_, out string sql_, out List<MySqlParameter> paras_)
		{
			...
			sql_ += $" INTO {TableName} (`CashAuditID`, `UserID`, `UserKind`, `FromMode`, `FromId`, `AppID`, `OperatorID`, `CountryID`, `CurrencyID`, `Mobile`, `Amount`, `CashRate`, `BankCode`, `BankName`, `AccName`, `AccNumber`, `Channels`, `Status`, `ApplyTime`, `AuditTime`, `OperatorUser`, `BankID`, `Paytype`, `Channel`, `RequestParam`, `Remark`, `IsAudit`, `AmountBalance`, `AmountBonus`, `BankOrderId`, `RequestTime`, `ResponseTime`, `CallbackTime`, `Reason`, `UserBankID`) VALUE (@CashAuditID, @UserID, @UserKind, @FromMode, @FromId, @AppID, @OperatorID, @CountryID, @CurrencyID, @Mobile, @Amount, @CashRate, @BankCode, @BankName, @AccName, @AccNumber, @Channels, @Status, @ApplyTime, @AuditTime, @OperatorUser, @BankID, @Paytype, @Channel, @RequestParam, @Remark, @IsAudit, @AmountBalance, @AmountBonus, @BankOrderId, @RequestTime, @ResponseTime, @CallbackTime, @Reason, @UserBankID);";
			paras_ = new List<MySqlParameter>() 
			{
				...
				Database.CreateInParameter("@UserBankID", item.UserBankID != null ? item.UserBankID : (object)DBNull.Value, MySqlDbType.VarChar),
			};
		}
		...
		#region RemoveByUserBankID
		/// <summary>
		/// 按字段删除
		/// </summary>
		/// /// <param name = "userBankID">l_bra_user_bank(UserBankID)</param>
		/// <param name="tm_">事务管理对象</param>
		public int RemoveByUserBankID(string userBankID, TransactionManager tm_ = null)
		{
			RepairRemoveByUserBankIDData(userBankID, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> RemoveByUserBankIDAsync(string userBankID, TransactionManager tm_ = null)
		{
			RepairRemoveByUserBankIDData(userBankID, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairRemoveByUserBankIDData(string userBankID, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"DELETE FROM {TableName} WHERE " + (userBankID != null ? "`UserBankID` = @UserBankID" : "`UserBankID` IS NULL");
			paras_ = new List<MySqlParameter>();
			if (userBankID != null)
				paras_.Add(Database.CreateInParameter("@UserBankID", userBankID, MySqlDbType.VarChar));
		}
		#endregion // RemoveByUserBankID
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutUserBankIDByPK(string cashAuditID, string userBankID, TransactionManager tm_ = null)
		{
			RepairPutUserBankIDByPKData(cashAuditID, userBankID, out string sql_, out List<MySqlParameter> paras_);
			return Database.ExecSqlNonQuery(sql_, paras_, tm_);
		}
		public async Task<int> PutUserBankIDByPKAsync(string cashAuditID, string userBankID, TransactionManager tm_ = null)
		{
			RepairPutUserBankIDByPKData(cashAuditID, userBankID, out string sql_, out List<MySqlParameter> paras_);
			return await Database.ExecSqlNonQueryAsync(sql_, paras_, tm_);
		}
		private void RepairPutUserBankIDByPKData(string cashAuditID, string userBankID, out string sql_, out List<MySqlParameter> paras_)
		{
			sql_ = $"UPDATE {TableName} SET `UserBankID` = @UserBankID  WHERE `CashAuditID` = @CashAuditID";
			paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@UserBankID", userBankID != null ? userBankID : (object)DBNull.Value, MySqlDbType.VarChar),
				Database.CreateInParameter("@CashAuditID", cashAuditID, MySqlDbType.VarChar),
			};
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>受影响的行数</return>
		public int PutUserBankID(string userBankID, TransactionManager tm_ = null)
		{
			string sql_ = $"UPDATE {TableName} SET `UserBankID` = @UserBankID";
			var parameter_ = Database.CreateInParameter("@UserBankID", userBankID != null ? userBankID : (object)DBNull.Value, MySqlDbType.VarChar);
			return Database.ExecSqlNonQuery(sql_, new MySqlParameter[] { parameter_ }, tm_);
		}
		public async Task<int> PutUserBankIDAsync(string userBankID, TransactionManager tm_ = null)
		{
			string sql_ = $"UPDATE {TableName} SET `UserBankID` = @UserBankID";
			var parameter_ = Database.CreateInParameter("@UserBankID", userBankID != null ? userBankID : (object)DBNull.Value, MySqlDbType.VarChar);
			return await Database.ExecSqlNonQueryAsync(sql_, new MySqlParameter[] { parameter_ }, tm_);
		}
		#endregion // PutUserBankID
		#endregion // PutXXX
		#endregion // Put
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return></return>
		public string GetUserBankIDByPK(string cashAuditID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@CashAuditID", cashAuditID, MySqlDbType.VarChar),
			};
			return (string)GetScalar("`UserBankID`", "`CashAuditID` = @CashAuditID", paras_, tm_);
		}
		public async Task<string> GetUserBankIDByPKAsync(string cashAuditID, TransactionManager tm_ = null)
		{
			var paras_ = new List<MySqlParameter>() 
			{
				Database.CreateInParameter("@CashAuditID", cashAuditID, MySqlDbType.VarChar),
			};
			return (string)await GetScalarAsync("`UserBankID`", "`CashAuditID` = @CashAuditID", paras_, tm_);
		}
		...
		/// /// <param name = "userBankID">l_bra_user_bank(UserBankID)</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID)
		{
			return GetByUserBankID(userBankID, 0, string.Empty, null);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID)
		{
			return await GetByUserBankIDAsync(userBankID, 0, string.Empty, null);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, TransactionManager tm_)
		{
			return GetByUserBankID(userBankID, 0, string.Empty, tm_);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, TransactionManager tm_)
		{
			return await GetByUserBankIDAsync(userBankID, 0, string.Empty, tm_);
		}
		...
		/// <param name = "top_">获取行数</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, int top_)
		{
			return GetByUserBankID(userBankID, top_, string.Empty, null);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, int top_)
		{
			return await GetByUserBankIDAsync(userBankID, top_, string.Empty, null);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, int top_, TransactionManager tm_)
		{
			return GetByUserBankID(userBankID, top_, string.Empty, tm_);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, int top_, TransactionManager tm_)
		{
			return await GetByUserBankIDAsync(userBankID, top_, string.Empty, tm_);
		}
		...
		/// <param name = "sort_">排序表达式</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, string sort_)
		{
			return GetByUserBankID(userBankID, 0, sort_, null);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, string sort_)
		{
			return await GetByUserBankIDAsync(userBankID, 0, sort_, null);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, string sort_, TransactionManager tm_)
		{
			return GetByUserBankID(userBankID, 0, sort_, tm_);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, string sort_, TransactionManager tm_)
		{
			return await GetByUserBankIDAsync(userBankID, 0, sort_, tm_);
		}
		...
		/// <param name="tm_">事务管理对象</param>
		/// <return>实体对象集合</return>
		public List<Sc_cash_auditEO> GetByUserBankID(string userBankID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(userBankID != null ? "`UserBankID` = @UserBankID" : "`UserBankID` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (userBankID != null)
				paras_.Add(Database.CreateInParameter("@UserBankID", userBankID, MySqlDbType.VarChar));
			return Database.ExecSqlList(sql_, paras_, tm_, Sc_cash_auditEO.MapDataReader);
		}
		public async Task<List<Sc_cash_auditEO>> GetByUserBankIDAsync(string userBankID, int top_, string sort_, TransactionManager tm_)
		{
			var sql_ = BuildSelectSQL(userBankID != null ? "`UserBankID` = @UserBankID" : "`UserBankID` IS NULL", top_, sort_);
			var paras_ = new List<MySqlParameter>();
			if (userBankID != null)
